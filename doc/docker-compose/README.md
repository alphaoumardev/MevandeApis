...
1.在文件编辑器上，使用全局替换的方式，将文件夹下的所有 `54.196.168.190`替换为服务器的ip
...
请自行54.196.168.190替换为服务器ip

 - mysql: 使用数据库连接工具进行连接， 端口3306 账号及密码 root/root
 - minio: http://54.196.168.190:9000 账号及密码 admin/admin123456
 - redis: 端口6379，没有密码
 - nacos: http://54.196.168.190:8848/nacos 账号及密码 nacos/nacos
 - kibana: http://54.196.168.190:5601
 - rocketmq-dashboard：http://54.196.168.190:8180


6.访问minio管理页面，右下角有个加号，创建存储区域(create bucker) 名为`mevande`
...
http://54.196.168.190:5601/app/dev_tools#/console
