...
1.在文件编辑器上，使用全局替换的方式，将文件夹下的所有 `45.79.135.62`替换为服务器的ip
...
请自行45.79.135.62替换为服务器ip

 - mysql: 使用数据库连接工具进行连接， 端口3306 账号及密码 root/root
 - minio: http://45.79.135.62:9000 账号及密码 admin/admin123456
 - redis: 端口6379，没有密码
 - nacos: http://45.79.135.62:8848/nacos 账号及密码 nacos/nacos
 - kibana: http://45.79.135.62:5601
 - rocketmq-dashboard：http://45.79.135.62:8180
...
http://45.79.135.62:5601/app/dev_tools#/console
