...
1.在文件编辑器上，使用全局替换的方式，将文件夹下的所有 `3.84.182.172`替换为服务器的ip
...
请自行3.84.182.172替换为服务器ip

 - mysql: 使用数据库连接工具进行连接， 端口3306 账号及密码 root/root
 - minio: http://3.84.182.172:9000 账号及密码 admin/admin123456
 - redis: 端口6379，没有密码
 - nacos: http://3.84.182.172:8848/nacos 账号及密码 nacos/nacos
 - kibana: http://3.84.182.172:5601
 - rocketmq-dashboard：http://3.84.182.172:8180
...
http://3.84.182.172:5601/app/dev_tools#/console
