 ...
 */
public class MevandeCanalBinlogEventProcessorFactory implements CanalBinlogEventProcessorFactory {
    ...
    private MevandeCanalBinlogEventProcessorFactory() {
    }

    public static MevandeCanalBinlogEventProcessorFactory of() {
        return new MevandeCanalBinlogEventProcessorFactory();
    }
}
