package com.mev.cloud.search.canal;
...
public class MevandeCanalGlue implements CanalGlue
{
    ...
    private MevandeCanalGlue(CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory) {
        this.canalBinlogEventProcessorFactory = canalBinlogEventProcessorFactory;
    }

    public static MevandeCanalGlue of(CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory) {
        return new MevandeCanalGlue(canalBinlogEventProcessorFactory);
    }
}
